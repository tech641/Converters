...
import "./TradeLiscense.css"; // reuse your page styles
...
function ImporterBank() {
  const title = "Upload Trade Lisence";
  const addLabel = "Add Trade Lisence";
  const importLabel = "Import";
  const downloadLabel = "Download Trade Lisence Excel";
  const accept = ".pdf,image/*";
  const resultsTitle = "Trade Lisence Results";
  const downloadFileName = "trade_lisence.xlsx";
  ...
  async function handleImport() {
    ...
    try {
      ...
      navigate("/converts/tradelicense/tableresult", {
        state: {
          title: "Trade License Results",
          subtitle: "Sample parsed output (dummy)",
          columns,
          rows,
          downloadLabel: "Download Trade License",
          downloadFileName: "trade_license.csv",
        },
      });
    } finally {
      clearInterval(timer);
