...
import "./EmiratesId.css"; // reuse your page styles
...
function ImporterBank() {
  ...
  const addLabel = "Add Emirates ID";
  const importLabel = "Import";
  const downloadLabel = "Download Emirates ID Excel";
  const accept = ".pdf,image/*";
  const resultsTitle = "Emirates ID Results";
  const downloadFileName = "emirates_id.xlsx";
    ...
    try {
      ...
      navigate("/converts/emiratesid/tableresult", {
        state: {
          ...
          downloadFileName: "emirates_id.csv",
        },
      });
    } finally {
      clearInterval(timer);
