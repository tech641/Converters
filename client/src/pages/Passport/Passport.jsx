...
import "./Passport.css"; // reuse your page styles
...
function ImporterBank() {
  const title = "Upload Passport";
  const addLabel = "Add Passport";
  const importLabel = "Import";
  const downloadLabel = "Download Passport Excel";
  const accept = ".pdf,image/*";
  const resultsTitle = "Passport Results";
  const downloadFileName = "passport.xlsx";
  ...
  async function handleImport() {
    ...
    try {
      ...
      navigate("/converts/passport/tableresult", {
        state: {
