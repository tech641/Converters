...
import "./Visa.css"; // reuse your page styles
...
function ImporterBank() {
  const title = "Upload Visa";
  const addLabel = "Add Visa";
  const importLabel = "Import";
  const downloadLabel = "Download Visa Excel";
  const accept = ".pdf,image/*";
  const resultsTitle = "Visa Results";
  const downloadFileName = "visa.xlsx";
  ...
  async function handleImport() {
    ...
    try {
      ...
      navigate("/converts/visa/tableresult", {
        state: {
          title: "Visa Results",
