...
import "./Bills.css"; // reuse your page styles
...
function ImporterBank() {
  const title = "Upload Bills";
  const addLabel = "Add Bills";
  const importLabel = "Import";
  const downloadLabel = "Download Bills";
  const accept = ".pdf,image/*";
  const resultsTitle = "Bills Results";
  const downloadFileName = "bills.xlsx";
